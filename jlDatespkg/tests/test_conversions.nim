...
test "Test conversion to and from unix":
    ...
    check $(unix2datetime(1095379198.75)) == "2004-09-16T23:59:58.75"
    check $(unix2datetime(1095379199.00)) == "2004-09-16T23:59:59"
    check $(unix2datetime(1095379199.25)) == "2004-09-16T23:59:59.25"
    check $(unix2datetime(1095379199.50)) == "2004-09-16T23:59:59.5"
    check $(unix2datetime(1095379199.75)) == "2004-09-16T23:59:59.75"
    check $(unix2datetime(1095379200.00)) == "2004-09-17T00:00:00"
    check $(unix2datetime(1095379200.25)) == "2004-09-17T00:00:00.25"
    check $(unix2datetime(1095379200.50)) == "2004-09-17T00:00:00.5"
    check $(unix2datetime(1095379200.75)) == "2004-09-17T00:00:00.75"
    check $(unix2datetime(1095379201.00)) == "2004-09-17T00:00:01"
    check $(unix2datetime(1095379201.25)) == "2004-09-17T00:00:01.25"
    check $(unix2datetime(915148798.75)) == "1998-12-31T23:59:58.75"
    check $(unix2datetime(915148799.00)) == "1998-12-31T23:59:59"
    check $(unix2datetime(915148799.25)) == "1998-12-31T23:59:59.25"
    check $(unix2datetime(915148799.50)) == "1998-12-31T23:59:59.5"
    check $(unix2datetime(915148799.75)) == "1998-12-31T23:59:59.75"
    check $(unix2datetime(915148800.00)) == "1999-01-01T00:00:00"
    check $(unix2datetime(915148800.25)) == "1999-01-01T00:00:00.25"
    check $(unix2datetime(915148800.50)) == "1999-01-01T00:00:00.5"
    check $(unix2datetime(915148800.75)) == "1999-01-01T00:00:00.75"
    check $(unix2datetime(915148801.00)) == "1999-01-01T00:00:01"
    check $(unix2datetime(915148801.25)) == "1999-01-01T00:00:01.25"
